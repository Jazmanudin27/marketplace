...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('permission:manage-inventory')->group(function () {
        ...
        Route::get('/inventory/{product}/ledger', function () {
            return redirect()->route('inventory.mutations.index');
        ...
        Route::get('/spks/scan-karung', [\App\Http\Controllers\Inventory\SpkController::class, 'scanKarungPage'])->name('spks.scan_karung');
        Route::post('/spks/scan-karung', [\App\Http\Controllers\Inventory\SpkController::class, 'processScanKarung'])->name('spks.process_scan_karung');
    ...
    Route::middleware('permission:view-warehouse-reports')->group(function () {
        ...
        Route::post('/orders/{id}/sync-single-fee', [ReportController::class, 'syncSingleOrderFee'])->name('orders.sync_single_fee');
    });
    ...
    Route::get('/fix/compare-stats-completed', [\App\Http\Controllers\SecretRepairDashboardController::class, 'compareStatsCompleted'])->name('secret_repair.compare_stats_completed');
