...
class RoleController extends Controller
{
    private function getPermissionGroups()
    {
        ...
        return [
            ...
            'Gudang Jadi' => [
                'inventory.index' => 'Lihat Stok/Mutasi Gudang Jadi',
                'inventory.ledger' => 'Lihat Kartu Stok Jadi',
                'inventory.adjust' => 'Penyesuaian Stok Jadi (Adjust)',
                'stock-opnames.index' => 'Lihat Laporan/Daftar Stok Opname',
            ...
            'Marketing' => [
                ...
                'marketing.ads.index'   => 'Melihat Dashboard Keputusan (Ads)',
                'marketing.teams.index' => 'Melihat Target Komisi (Teams)',
            ],
            'Chat Inbox' => [
