...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-success bg-opacity-10 d-flex align-items-center justify-content-between py-2 px-3">
        <div>
            <h6 class="fw-bold mb-0 text-dark">
                <i class="fas fa-link text-success me-2"></i>Daftar Produk Sudah Ditautkan
            </h6>
            <small class="text-muted">Kelola sinkronisasi stok dan pengaturan produk yang terhubung ke Master
                Product</small>
        </div>
            ...
            <table class="table table-sm table-bordered table-hover align-middle mb-0">
                <thead class="table-light">
                    <tr>
                        ...
                        <th>Status Master</th>
                        <th>Toko / Channel</th>
                        <th class="pe-3 text-center" style="width:200px;">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                                                ...
                                                <div class="modal-body py-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="safetyStock-{{ $product->id }}"
                                                            class="form-label fw-semibold small">Stok Pengaman (Safety
                                                            Stock)</label>
