    ...
    <form method="GET" action="{{ route('marketplace_products.index') }}">
        ...
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="sku" class="form-control form-control-sm" placeholder="Cari SKU..."
                    value="{{ request('sku') }}">
            </div>
...
<div class="dashboard-card">
    <div class="card-header-line d-flex align-items-center justify-content-between mb-3">
        <div>
            <h5 class="mb-0">
                <i class="fas fa-store text-primary me-2"></i>Daftar Semua Produk Marketplace
            </h5>
            <p class="text-muted mb-0 mt-1" style="font-size:0.75rem;">Kelola seluruh produk yang terdaftar di akun
                marketplace Anda</p>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="ps-3">
                            @if ($product->marketplace_sku)
                                <code class="text-primary font-monospace"
                                    style="font-size:0.75rem;">{{ $product->marketplace_sku }}</code>
                            @else
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                @endif
                                <div>
                                    <div class="fw-semibold text-white" style="font-size:0.82rem;">{{ $product->name }}
                                    </div>
                                    <div class="text-secondary extra-small mt-0.5">ID:
                            ...
                            @if (!$product->masterProduct)
                                <div class="d-flex gap-1 justify-content-center align-items-center">
                                    ...
                                    <form action="{{ route('marketplace_products.clone_and_publish', $product->id) }}"
                                        method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-secondary btn-action-sm"
                                            title="Salin Toko">
                                ...
                                <form id="link-form-{{ $product->id }}"
                                    ...
                                    class="d-none mt-2 p-2 border border-secondary border-opacity-10 rounded text-start"
                                        ...
                                        <div class="modal-content"
                                            ...
                                            <form
                                                ...
                                                <div class="modal-body py-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label
                                                            class="form-label d-block fw-semibold text-secondary mb-2"
                                                            style="font-size:0.8rem;">Sinkronisasi Stok</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="safetyStock-{{ $product->id }}"
                                                            ...
                                                            style="font-size:0.8rem;">Stok Pengaman (Safety
                                                            Stock)</label>
                                                        <input type="number"
                                                            class="form-control form-control-sm form-control-dark"
                                                            name="safety_stock" id="safetyStock-{{ $product->id }}"
                                                            min="0" value="{{ $product->safety_stock ?? 0 }}"
                                                            required>
                                                        <div class="form-text mt-1"
                                                            style="font-size: 0.75rem; color: var(--text-muted);">
