        ...
        <div class="col-lg-5 col-md-12">
            <div class="card border shadow-sm rounded-4 bg-white mb-3">
                <div class="card-header bg-primary bg-opacity-10 py-3 px-4 border-bottom d-flex align-items-center gap-2">
                    <span class="bg-primary rounded-circle d-flex align-items-center justify-content-center text-white"
                        style="width: 28px; height: 28px;">
                        <i class="bi bi-sliders"></i>
                    </span>
                    <div>
                        <h6 class="mb-0 fw-bold text-dark">Parameter Keuangan Produk</h6>
                        <small class="text-muted" style="font-size: 0.72rem;">Pilih produk atau masukkan data
                            manual.</small>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form id="roasCalcForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold text-primary small text-uppercase"
                                style="font-size:.68rem;">Pilih Produk Toko (Mengambil Harga & HPP Otomatis)</label>
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-6">
                                <label class="form-label fw-bold text-secondary small text-uppercase"
                                    style="font-size:.65rem;">Harga Jual Produk (Rp)</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light">Rp</span>
                                    <input type="text" id="salePrice" class="form-control rounded-end-3 input-rupiah"
                                        value="229.900" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <label class="form-label fw-bold text-secondary small text-uppercase"
                                    style="font-size:.65rem;">COGS / HPP Produk (Rp)</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-light">Rp</span>
                                    <input type="text" id="cogs" class="form-control rounded-end-3 input-rupiah"
                                        value="85.000" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 d-flex justify-content-between align-items-center bg-light p-2 rounded-3 border">
                            <label class="form-label fw-bold text-secondary small text-uppercase mb-0"
                                style="font-size:.65rem;"><i class="bi bi-gear-wide-connected me-1"></i> Mode Potongan
                                Marketplace</label>
                            <div class="btn-group btn-group-sm" role="group">
                                <input type="radio" class="btn-check" name="feeCalculationMode" id="modeSimple"
                                    autocomplete="off" checked>
                                <label class="btn btn-outline-primary px-3 fw-bold btn-sm" style="font-size:0.7rem;"
                                    for="modeSimple">Simpel</label>

                                <input type="radio" class="btn-check" name="feeCalculationMode" id="modeDetail"
                                    autocomplete="off">
                                <label class="btn btn-outline-primary px-3 fw-bold btn-sm" style="font-size:0.7rem;"
                                    for="modeDetail">Detail Program</label>
                            </div>
                        </div>
                        ...
                        <div id="simpleFeeContainer" class="p-3 bg-light rounded-3 mb-4 border">
                            <div class="row g-2">
                                <div class="col-6">
                                    <label class="form-label fw-bold text-secondary small text-uppercase"
                                        style="font-size:.6rem;">Estimasi Potongan (%)</label>
                                    <div class="input-group input-group-sm">
                                        <input type="number" id="simpleFeePct" class="form-control" value="15.00"
                                            step="0.1">
                                        <span class="input-group-text bg-white">%</span>
                                    </div>
                                    <div class="form-text text-muted" style="font-size:.58rem; line-height:1.2;">Total
                                        perkiraan potongan admin & ongkir.</div>
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-bold text-secondary small text-uppercase"
                                        style="font-size:.6rem;">Tetap per Order (Rp)</label>
                                    <div class="input-group input-group-sm">
                                        <span class="input-group-text bg-white">Rp</span>
                                        <input type="text" id="simpleFixedFee" class="form-control input-rupiah"
                                            value="1.250">
                                    </div>
                                    <div class="form-text text-muted" style="font-size:.58rem; line-height:1.2;">Biaya admin
                                        tetap per transaksi.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="detailFeeContainer" class="p-3 bg-light rounded-3 mb-4 border d-none">
                            <h6 class="fw-bold text-secondary small text-uppercase border-bottom pb-1 mb-2"
                                style="font-size:.65rem;">Biaya Administrasi & Layanan</h6>
                            <div class="row g-2 mb-3">
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Biaya Admin (%)</label>
                                    <input type="number" id="adminFee" class="form-control form-control-sm"
                                        value="8.25" step="0.01">
                                </div>
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Premi (%)</label>
                                    <input type="number" id="premiFee" class="form-control form-control-sm"
                                        value="0.50" step="0.01">
                                </div>
                                <div class="col-12">
                                    <label class="form-label text-muted small mb-1">Biaya Tetap Per Pesanan (Rp)</label>
                                    <input type="text" id="fixedFee"
                                        class="form-control form-control-sm input-rupiah" value="1.250">
                                </div>
                            </div>

                            <h6 class="fw-bold text-secondary small text-uppercase border-bottom pb-1 mb-2"
                                style="font-size:.65rem;">Program Pemasaran (Ikut Serta)</h6>
                            <div class="row g-2">
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Gratis Ongkir Xtra (%)</label>
                                    <input type="number" id="ongkirXtra" class="form-control form-control-sm"
                                        value="7.50" step="0.01">
                                </div>
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Promo Xtra (%)</label>
                                    <input type="number" id="promoXtra" class="form-control form-control-sm"
                                        value="4.50" step="0.01">
                                </div>
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Promo Xtra+ / Plus (%)</label>
                                    <input type="number" id="promoPlus" class="form-control form-control-sm"
                                        value="2.00" step="0.01">
                                </div>
                                <div class="col-6">
                                    <label class="form-label text-muted small mb-1">Live Xtra (%)</label>
                                    <input type="number" id="liveXtra" class="form-control form-control-sm"
                                        value="2.00" step="0.01">
                                </div>
                                <div class="col-12">
                                    <label class="form-label text-muted small mb-1">Spaylater Buyer (3 Bulan) (%)</label>
                                    <input type="number" id="spaylater" class="form-control form-control-sm"
                    ...
                    <div class="card border-0 bg-danger bg-opacity-10 text-danger-emphasis rounded-3">
                        <div class="card-body p-3 text-center">
                            <span class="text-uppercase fw-bold" style="font-size: 0.7rem; letter-spacing: 0.5px;">BEP
                                (Break Even Point) ROAS</span>
                            <h2 id="bepRoasVal" class="fw-extrabold my-2 text-danger">4.61</h2>
                            <div style="font-size: 0.72rem;">
                                Organik Margin: <strong id="gpmVal">Rp 73.755</strong> (<strong
                                    id="gpmPct">32.08%</strong>)
                            </div>
                            <div class="text-muted mt-2" style="font-size: 0.65rem; line-height: 1.35;">
                                *BEP ROAS dihitung berdasarkan harga jual setelah dikurangi HPP dan total biaya marketplace
                                (Rp <span id="totalFeeNomVal">71.145</span>).
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-7 col-md-12">
            ...
            <div class="card border shadow-sm rounded-4 bg-white mb-3">
                <div class="card-header bg-info bg-opacity-10 py-3 px-4 border-bottom d-flex align-items-center gap-2">
                    <span class="bg-info rounded-circle d-flex align-items-center justify-content-center text-white"
                        style="width: 28px; height: 28px;">
                        <i class="bi bi-grid-3x3-gap-fill"></i>
                    </span>
                    <div>
                        <h6 class="mb-0 fw-bold text-dark">Matriks Target ROAS & Profit Bersih</h6>
                        <small class="text-muted" style="font-size: 0.72rem;">Skenario target ROAS Kompetitif,
                            Konservatif, dan Prospektif.</small>
                    </div>
                </div>
                <div class="card-body p-3">
                    <!-- Kompetitif -->
                    <div class="border rounded-3 mb-3">
                        <div class="bg-danger bg-opacity-75 text-white fw-bold px-3 py-1.5 text-uppercase"
                            style="font-size: 0.72rem; border-top-left-radius: 7px; border-top-right-radius: 7px;">
                    ...
                    <!-- Konservatif -->
                    <div class="border rounded-3 mb-3">
                        <div class="bg-success bg-opacity-75 text-white fw-bold px-3 py-1.5 text-uppercase"
                            style="font-size: 0.72rem; border-top-left-radius: 7px; border-top-right-radius: 7px;">
                    ...
                    <div class="border rounded-3">
                        <div class="bg-primary bg-opacity-75 text-white fw-bold px-3 py-1.5 text-uppercase"
                            style="font-size: 0.72rem; border-top-left-radius: 7px; border-top-right-radius: 7px;">
            ...
            <div class="card border shadow-sm rounded-4 bg-white">
                <div class="card-header bg-warning bg-opacity-10 py-3 px-4 border-bottom d-flex align-items-center gap-2">
                    <span class="bg-warning rounded-circle d-flex align-items-center justify-content-center text-dark"
                        style="width: 28px; height: 28px;">
                        <i class="bi bi-sliders2"></i>
                    </span>
                    <div>
                        <h6 class="mb-0 fw-bold text-dark">Estimasi Hasil Dashboard Iklan</h6>
                        <small class="text-muted" style="font-size: 0.72rem;">Ubah target ROAS untuk menguji
                            profitabilitas langsung.</small>
                    </div>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3 align-items-center">
                        <div class="col-md-5">
                            <label class="form-label fw-bold text-secondary small text-uppercase"
                                style="font-size:.65rem;">Masukkan ROAS Target</label>
                            <input type="number" id="simRoas"
                                class="form-control form-control-sm rounded-3 border-warning" value="20"
                                min="0.1" step="0.1">
                            <div class="form-text text-muted" style="font-size: .65rem;">Ketik angka ROAS untuk melihat
                                simulasi profit.</div>
                        </div>
                        <div class="col-md-7">
                                ...
                                <table class="table table-bordered align-middle text-center mb-0"
                                    ...
                                    <tbody>
                                        <tr class="fw-bold text-dark">
                                            ...
                                            <td><span id="simAdCostPct">5.00%</span><br><small
                                                    class="text-muted fw-normal" id="simAdCostNom">Rp 11.495</small></td>
                                            <td><span id="simProfitPct" class="text-success">16.69%</span><br><small
                                                    class="text-success fw-bold" id="simProfitNom">Rp 38.362</small></td>
                                        </tr>
                                        <tr class="text-muted">
                                            <td>Akselerasi (-30%) (<span id="simRoasAccLbl">14</span>)</td>
                                            <td><span id="simAdCostPctAcc">7.14%</span><br><small
                                                    class="text-muted fw-normal" id="simAdCostNomAcc">Rp 16.421</small>
                                            </td>
                                            <td><span id="simProfitPctAcc" class="text-success">14.54%</span><br><small
                                                    class="text-success fw-bold" id="simProfitNomAcc">Rp 33.435</small>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        function calculateMatrix() {
            ...
            scenarioPrefixes.forEach(prefix => {
                ...
                if (adCostNomAccEl) adCostNomAccEl.innerText = 'Rp ' + Math.round(adCostNomAcc).toLocaleString(
                    'id-ID');
                ...
                if (profitNomAccEl) profitNomAccEl.innerText = 'Rp ' + Math.round(profitNomAcc).toLocaleString(
                    'id-ID');
            ...
            if (simAdCostNomAccEl) simAdCostNomAccEl.innerText = 'Rp ' + Math.round(simAdCostNomValAcc).toLocaleString(
                'id-ID');
