    ...
    <div class="row g-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2.4 col-lg col-6">
                    <div class="card border-0 shadow-sm bg-white h-100"
                        style="border-left: 4px solid #0d6efd !important; transition: transform 0.2s;"
                        ...
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-uppercase fw-bold text-secondary"
                                    style="font-size: 0.68rem; letter-spacing: 0.5px;">Champions</span>
                ...
                <div class="col-md-2.4 col-lg col-6">
                    <div class="card border-0 shadow-sm bg-white h-100"
                        style="border-left: 4px solid #198754 !important; transition: transform 0.2s;"
                        onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-uppercase fw-bold text-secondary"
                                    style="font-size: 0.68rem; letter-spacing: 0.5px;">Loyal</span>
                ...
                <div class="col-md-2.4 col-lg col-6">
                    <div class="card border-0 shadow-sm bg-white h-100"
                        style="border-left: 4px solid #ffc107 !important; transition: transform 0.2s;"
                        onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-uppercase fw-bold text-secondary"
                                    style="font-size: 0.68rem; letter-spacing: 0.5px;">At Risk</span>
                ...
                <div class="col-md-2.4 col-lg col-6">
                    <div class="card border-0 shadow-sm bg-white h-100"
                        style="border-left: 4px solid #dc3545 !important; transition: transform 0.2s;"
                        onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-uppercase fw-bold text-secondary"
                                    style="font-size: 0.68rem; letter-spacing: 0.5px;">Hibernating</span>
                                <h3 class="mb-0 fw-extrabold text-dark mt-1">{{ count($segments['Hibernating'] ?? []) }}
                                </h3>
                            </div>
                ...
                <div class="col-md-2.4 col-lg col-12">
                    <div class="card border-0 shadow-sm bg-white h-100"
                        style="border-left: 4px solid #6c757d !important; transition: transform 0.2s;"
                        onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform='none'">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-uppercase fw-bold text-secondary"
                                    style="font-size: 0.68rem; letter-spacing: 0.5px;">New Customers</span>
                                <h3 class="mb-0 fw-extrabold text-dark mt-1">{{ count($segments['New Customers'] ?? []) }}
                                </h3>
                            </div>
        ...
        <div class="col-12">
            <div class="card border shadow-sm rounded-4 bg-white">
                <div
                    class="card-header bg-light py-3 px-4 border-bottom d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <small class="text-muted" style="font-size: 0.72rem;">Kelompokkan customer loyal vs pasif dan
                                targetkan langsung lewat iklan retargeting.</small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 flex-grow-1 flex-md-grow-0 justify-content-end">
                        <div class="input-group input-group-sm" style="max-width: 250px;">
                            ...
                            <input type="text" id="customerSearch" class="form-control border-start-0 ps-0 rounded-end-3"
                    ...
                    <ul class="nav nav-pills card-header-pills" id="rfmTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active fw-bold small py-1 px-3" id="champions-tab" data-bs-toggle="tab"
                                data-bs-target="#champions" type="button" role="tab" aria-controls="champions"
                                aria-selected="true">🏆 Champions</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold small py-1 px-3 ms-1" id="loyal-tab" data-bs-toggle="tab"
                                data-bs-target="#loyal" type="button" role="tab" aria-controls="loyal"
                                aria-selected="false">❤️ Loyal</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold small py-1 px-3 ms-1" id="atRisk-tab" data-bs-toggle="tab"
                                data-bs-target="#atRisk" type="button" role="tab" aria-controls="atRisk"
                                aria-selected="false">⚠️ At Risk</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold small py-1 px-3 ms-1" id="hibernating-tab"
                                data-bs-toggle="tab" data-bs-target="#hibernating" type="button" role="tab"
                                aria-controls="hibernating" aria-selected="false">🌙 Hibernating</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold small py-1 px-3 ms-1" id="newCustomers-tab"
                                data-bs-toggle="tab" data-bs-target="#newCustomers" type="button" role="tab"
                                aria-controls="newCustomers" aria-selected="false">✨ New</button>
                        </li>
                    </ul>
                </div>
                        ...
                        @foreach (['Champions', 'Loyal', 'At Risk', 'Hibernating', 'New Customers'] as $segmentKey)
                            ...
                            <div class="tab-pane fade @if ($loop->first) show active @endif"
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div
                                            class="card border border-{{ $themeColor }} border-opacity-25 rounded-3 bg-{{ $themeColor }} bg-opacity-5">
                                            <div class="card-body p-3">
                                                <h6 class="fw-bold text-white mb-1 d-flex align-items-center gap-1">
                                                ...
                                                <p class="text-muted" style="font-size: 0.72rem; line-height: 1.35;">
                                                    Kirim seluruh database kontak segmen
                                                    <strong>{{ $segmentKey }}</strong> ini langsung ke audiens khusus
                                                    iklan Anda.
                                                </p>
                                                ...
                                                <form action="{{ route('marketing.ads.rfm.sync') }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label fw-bold text-white small text-uppercase"
                                                            style="font-size:.65rem;">Pilih Akun Iklan TikTok</label>
                                                        <select name="ads_account_id"
                                                    ...
                                                    @if ($adsAccounts->isEmpty())
                                                        <div class="form-text text-danger mt-1 text-center"
                                                            style="font-size: .65rem;">
                                                            <i class="bi bi-x-circle-fill"></i> Akun TikTok Ads belum
                                                            terhubung.
                                                        </div>
                                                    @endif
                                                </form>
                                                ...
                                                <tbody>
                                                    @forelse($tabCustomers as $cust)
                                                        <tr class="customer-row">
                                                            <td>
                                                                <div class="fw-semibold text-dark search-name">
                                                                    {{ $cust['name'] }}</div>
                                                            </td>
                                                            <td>
                                                                <code
                                                                    class="search-phone">{{ substr($cust['phone'], 0, 5) }}****{{ substr($cust['phone'], -4) }}</code>
                                                            </td>
