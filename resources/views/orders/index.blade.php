        ...
        <div class="col-md-12">
            ...
            <div class="card border shadow-sm overflow-hidden">
                <div class="card-header bg-info bg-opacity-10 d-flex justify-content-between align-items-center p-3 border-bottom">
                    <div>
                        <h6 class="mb-0 fw-bold text-dark"><i class="fas fa-shopping-cart me-2 text-info"></i>Daftar Pesanan</h6>
                                    ...
                                    @forelse($orders as $order)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="text-muted small mt-1" style="font-size:0.68rem;">ID: {{ $order->order_marketplace_id }}</div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end font-monospace">
                                                <strong class="text-dark small">Rp {{ number_format($order->total_amount, 0, ',', '.') }}</strong>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-{{ $order->status_badge ?? 'secondary' }}-subtle text-{{ $order->status_badge ?? 'secondary' }} border border-{{ $order->status_badge ?? 'secondary' }}-subtle" style="font-size:0.7rem; padding: 0.25em 0.5em;">
