        ...
        <div class="card border-0 shadow-sm rounded-3">
            <div class="card-header bg-primary text-white py-3 px-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-white-50">Pesanan manual akan tercatat dengan status Ready to Ship untuk antrean SPK</small>
                </div>
                <a href="{{ route('production_orders.requirements') }}" class="btn btn-outline-light btn-sm px-3 fw-semibold">
            ...
            <form action="{{ route('orders.store') }}" method="POST" id="manual-order-form">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label class="form-label form-label-sm fw-semibold">Akun / Toko Tujuan <span class="text-danger">*</span></label>
                            <select name="store_id" class="form-select form-select-sm select2" required style="width: 100%;">
                        ...
                        <div class="col-md-6">
                            <label class="form-label form-label-sm fw-semibold">No. Invoice / No. Pesanan (PO) <span class="text-danger">*</span></label>
                            <input type="text" name="invoice_number" class="form-control form-control-sm" required placeholder="Contoh: INV/2026/0012">
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label class="form-label form-label-sm fw-semibold">Nama Pembeli <span class="text-danger">*</span></label>
                            <input type="text" name="buyer_name" class="form-control form-control-sm" required placeholder="Nama lengkap pembeli">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label form-label-sm fw-semibold">No. HP Pembeli</label>
                            <input type="text" name="buyer_phone" class="form-control form-control-sm" placeholder="Contoh: 08123456789">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label form-label-sm fw-semibold">Alamat Pengiriman</label>
                            <textarea name="shipping_address" class="form-control form-control-sm" rows="2" placeholder="Alamat lengkap tujuan pengiriman..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive border rounded mb-3">
                        <table class="table table-sm table-bordered table-striped align-middle mb-0" id="table-order-items">
                            ...
                            <tbody>
                                <tr class="item-row">
                                    ...
                                    <td>
                                        <select name="items[0][master_product_id]" class="form-select form-select-sm product-select select2" required style="width:100%">
                                    ...
                                    <td>
                                        <input type="number" name="items[0][quantity]" class="form-control form-control-sm text-center qty-input" value="1" min="1" required>
                                    </td>
                                    <td>
                                        <input type="number" name="items[0][price]" class="form-control form-control-sm text-end price-input" value="0" min="0" required>
                                    </td>
                            ...
                            <tfoot>
                                <tr class="table-light fw-bold">
                                    ...
                                    <td class="text-end font-monospace text-success fs-6" id="order-grand-total">Rp 0</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <div class="card-footer bg-light py-3 px-4 d-flex justify-content-end gap-2">
                    <a href="{{ route('production_orders.requirements') }}" class="btn btn-sm btn-secondary px-3">Batal</a>
