        ...
        <div class="col-md-12">
            <div class="dashboard-card">
                ...
                <div class="card-header-line d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-0">
                            <i class="fas fa-folder me-2 text-primary"></i>Daftar Kategori
                        </h5>
                        <p class="text-muted mb-0 mt-1" style="font-size:0.75rem;">Kelola kategori produk</p>
                    </div>
                ...
                {{-- Filter --}}
                <form method="GET" action="{{ route('categories.index') }}" class="mt-3 mb-3">
                            ...
                            @forelse($categories as $i => $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="fw-semibold" style="font-size:0.82rem;">{{ $category->name }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-1 justify-content-center">
                                            <button type="button" class="btn btn-warning btn-action-sm edit-category-btn"
            ...
            <div class="modal-content overflow-hidden">
                <div class="d-flex align-items-center gap-3 p-3 border-bottom bg-primary bg-opacity-10">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="modal-title fw-bold fs-6 mb-0" id="createCategoryModalLabel">Tambah Kategori</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content overflow-hidden">
                <div class="d-flex align-items-center gap-3 p-3 border-bottom ">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="modal-title fw-bold fs-6 mb-0" id="editCategoryModalLabel">Edit Kategori</h5>
                ...
                <form id="edit-form" method="POST">
                    ...
                    <div class="modal-footer  px-4 py-3 border-top d-flex justify-content-between">
                        <button type="button"
                            class="btn btn-secondary btn-sm px-3 d-inline-flex align-items-center gap-1"
                            data-bs-dismiss="modal">
                            Batal
