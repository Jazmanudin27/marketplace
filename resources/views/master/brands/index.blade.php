                ...
                <div
                    ...
                    <div>
                        <h6 class="fw-bold mb-0 text-dark">
                            <i class="fas fa-certificate me-2 text-info"></i>Daftar Merk
                        </h6>
                        <small class="text-muted d-block">Kelola merk / brand produk</small>
                    </div>
                            ...
                            <tbody>
                                @forelse($brands as $i => $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <i class="fas fa-certificate me-2 text-secondary"></i>
                                            <span class="fw-semibold text-dark small">{{ $brand->name }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <button type="button" class="btn btn-warning btn-sm edit-brand-btn"
            ...
            <div class="modal-content overflow-hidden">
                <div class="d-flex align-items-center gap-3 p-3 border-bottom bg-primary bg-opacity-10">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="modal-title fw-bold fs-6 mb-0 text-dark" id="createBrandModalLabel">Tambah Merk</h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content overflow-hidden">
                <div class="d-flex align-items-center gap-3 p-3 border-bottom bg-warning bg-opacity-10">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="modal-title fw-bold fs-6 mb-0 text-dark" id="editBrandModalLabel">Edit Merk</h5>
