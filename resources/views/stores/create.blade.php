...
@section('content')
    <div class="form-page-wrapper">
        ...
        <div style="max-width: 680px; margin-top: 1rem;">
            ...
            {{-- TIKTOK SHOP --}}
            <div class="connect-card connect-card-tiktok">
                <div class="connect-card-left">
                    ...
                    <div class="connect-info">
                        ...
                        <div class="connect-desc">Hubungkan toko TikTok Shop Anda via OAuth resmi.</div>
                        <div class="connect-badges">
                            <span class="connect-badge badge-auto"><i class="fas fa-bolt"></i> Otomatis</span>
                            <span class="connect-badge badge-secure"><i class="fas fa-shield-alt"></i> OAuth 2.0</span>
                        </div>
                ...
                <a href="{{ route('tiktok.auth') }}" class="btn-connect btn-connect-tiktok" id="btn-tiktok-connect">
            ...
            <div class="oauth-info-box">
                ...
                <div>
                    ...
                    <ol
                        style="margin-top: 0.5rem; padding-left: 1rem; color: var(--text-secondary); font-size: 0.82rem; line-height: 1.7;">
...
@push('styles')
    <style>
        ...
        .connect-card:hover:not(.connect-card-disabled) {
