...
@section('content')
    <div class="manage-wrapper">
        ...
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show bg-success-glow border-success text-success mb-4"
        ...
        @if ($errors->any())
            <div class="alert alert-danger alert-dismissible fade show bg-danger-glow border-danger text-danger mb-4"
                role="alert" style="border-radius: 8px;">
                <i class="fas fa-exclamation-triangle me-1"></i> Gagal menyimpan. Silakan cek kembali input Anda.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        @endif
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="cat-icon-wrap"
                                                style="width: 36px; height: 36px; background: rgba({{ $category->color_rgb }}, 0.15); color: {{ $category->color }}; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <div class="d-inline-flex gap-1">
                                                                <button class="btn btn-warning btn-xs edit-item-btn"
                                                                    data-id="{{ $step->id }}"
            ...
            <div class="modal-content modal-dark-content">
                ...
                <form action="{{ route('faq.categories.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted">Subtitle Kategori</label>
                            <input type="text" name="subtitle" class="form-control form-control-dark"
                                placeholder="Contoh: Shopee & TikTok Shop">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">FontAwesome Icon</label>
                            <input type="text" name="icon" class="form-control form-control-dark" required
                                placeholder="Contoh: fas fa-plug">
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Hex Color</label>
                                <input type="text" name="color" class="form-control form-control-dark" required
                                    placeholder="Contoh: #6C63FF">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Color RGB (comma separated)</label>
                                <input type="text" name="color_rgb" class="form-control form-control-dark" required
                                    placeholder="Contoh: 108, 99, 255">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Estimasi Baca (mnt)</label>
                                <input type="text" name="read_time" class="form-control form-control-dark"
                                    placeholder="Contoh: 3 mnt">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Judul Alur Kerja</label>
                                <input type="text" name="workflow_title" class="form-control form-control-dark"
                                    required value="Alur Kerja">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Urutan Urutan Tampil</label>
                            <input type="number" name="sort_order" class="form-control form-control-dark" required
                                value="0">
                        </div>
                    </div>
            ...
            <div class="modal-content modal-dark-content">
                ...
                <form id="editCategoryForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label text-muted">Nama Kategori</label>
                            <input type="text" id="edit_cat_name" name="name"
                                class="form-control form-control-dark" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Subtitle Kategori</label>
                            <input type="text" id="edit_cat_subtitle" name="subtitle"
                                class="form-control form-control-dark">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">FontAwesome Icon</label>
                            <input type="text" id="edit_cat_icon" name="icon"
                                class="form-control form-control-dark" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Hex Color</label>
                                <input type="text" id="edit_cat_color" name="color"
                                    class="form-control form-control-dark" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Color RGB (comma separated)</label>
                                <input type="text" id="edit_cat_color_rgb" name="color_rgb"
                                    class="form-control form-control-dark" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Estimasi Baca (mnt)</label>
                                <input type="text" id="edit_cat_read_time" name="read_time"
                                    class="form-control form-control-dark">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Judul Alur Kerja</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="edit_cat_sort_order" name="sort_order"
                                class="form-control form-control-dark" required>
                        </div>
                    </div>
                    <div class="modal-footer modal-dark-footer">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="faq_category_id" class="form-select form-select-dark" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Tipe Item</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted">Judul / Pertanyaan</label>
                            <input type="text" name="title" class="form-control form-control-dark" required
                                placeholder="Contoh: Langkah 1 atau Bagaimana cara...">
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Konten / Jawaban (Mendukung HTML dasar seperti
                                &lt;strong&gt;, &lt;b&gt;, &lt;br&gt;)</label>
                            <textarea name="content" class="form-control form-control-dark" rows="5" required
                                placeholder="Isi penjelasan detail..."></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Nomor Urutan Tampil (Penting untuk Alur Kerja)</label>
                            <input type="number" name="sort_order" class="form-control form-control-dark" required
                                value="1">
                        </div>
                    </div>
                ...
                <form id="editItemForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Kategori</label>
                                <select id="edit_item_category_id" name="faq_category_id"
                                    class="form-select form-select-dark" required>
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}">{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted">Tipe Item</label>
                                <select id="edit_item_type" name="type" class="form-select form-select-dark" required>
                                    <option value="workflow">Langkah Alur Kerja (Workflow)</option>
                                    <option value="faq">Tanya Jawab (FAQ)</option>
                                </select>
                            </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted">Judul / Pertanyaan</label>
                            <input type="text" id="edit_item_title" name="title"
                                class="form-control form-control-dark" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Konten / Jawaban (Mendukung HTML dasar seperti
                                &lt;strong&gt;, &lt;b&gt;, &lt;br&gt;)</label>
                            <textarea id="edit_item_content" name="content" class="form-control form-control-dark" rows="5" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted">Nomor Urutan Tampil</label>
