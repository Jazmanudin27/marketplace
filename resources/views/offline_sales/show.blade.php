                ...
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="p-3 border rounded h-100 bg-light">
                                    ...
                                    <span class="font-monospace fw-semibold text-dark small">{{ $offlineSale->buyer_phone ?? '-' }}</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="p-3 border rounded h-100 bg-light">
                            ...
                            <div class="col-md-4">
                                <div class="p-3 border rounded h-100 bg-light">
                                    ...
                                    <span class="fw-semibold text-dark small">{{ $offlineSale->sold_at?->format('d M Y, H:i') ?? '-' }}</span>
                                </div>
                            </div>
                            @if($offlineSale->customer && $offlineSale->customer->address)
                                <div class="col-md-12">
                                    <div class="p-3 border rounded h-100 bg-light">
                                        ...
                                        <span class="text-secondary text-wrap small">{{ $offlineSale->customer->address }}</span>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-md-12">
                                    <div class="p-3 border border-warning rounded h-100 bg-warning bg-opacity-10">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6 text-dark small">
                                                <span class="text-muted">No. Telepon:</span> <strong class="font-monospace text-dark">{{ $offlineSale->dropshipper_phone ?? '-' }}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h6 class="fw-bold mb-0 text-dark" style="font-size:0.9rem;"><i class="fas fa-box me-2 text-primary"></i>Item Yang Dijual</h6>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($offlineSale->items as $item)
                                        <tr>
                                            ...
                                            <td><code class="text-primary font-monospace small">{{ $item->sku ?? '-' }}</code></td>
                                            <td class="text-center small">{{ $item->quantity }}</td>
                                            <td class="text-end font-monospace small">Rp {{ number_format($item->unit_price, 0, ',', '.') }}</td>
                                            <td class="text-end font-monospace text-success fw-bold small">Rp {{ number_format($item->subtotal, 0, ',', '.') }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    <div class="card-body p-3">
                        <div class="p-3 border rounded bg-light mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="font-monospace text-dark small">Rp {{ number_format($offlineSale->total_amount, 0, ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="p-3 border rounded bg-light">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="font-monospace text-dark small">Rp {{ number_format($offlineSale->paid_amount, 0, ',', '.') }}</span>
                            </div>
