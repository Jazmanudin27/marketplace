                                        ...
                                        @if (in_array($store->channel->code, ['shopee', 'tiktok']))
                                            ...
                                            @if ($store->channel->code === 'shopee')
                                                 <div class="mt-3">
                                                     ...
                                                     <input type="hidden" name="size_chart_ids[{{ $store->id }}]" id="size_chart_id_{{ $store->id }}" value="{{ $mappedSizeChartId ?? '' }}">
                                                     <div class="d-flex gap-2">
                                                         <select id="size_chart_select_{{ $store->id }}" class="form-select form-select-sm rounded-3 size-chart-selector" data-store-id="{{ $store->id }}">
                                                             ...
                                                             @if ($mappedSizeChartId)
                                                                 <option value="{{ $mappedSizeChartId }}" selected>ID: {{ $mappedSizeChartId }} (Tersimpan)</option>
                                                             @endif
                                                         </select>
                                                         <input type="number" id="size_chart_manual_{{ $store->id }}" class="form-control form-control-sm rounded-3 size-chart-manual-input" style="max-width: 160px;" placeholder="Input Manual ID" value="{{ $mappedSizeChartId ?? '' }}" data-store-id="{{ $store->id }}">
                                                     </div>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.success && Array.isArray(res.data) && res.data.length > 0) {
                            ...
                            // Reset hidden input dan manual input agar tidak ada ID yang dikirim
