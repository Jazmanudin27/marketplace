    ...
    <div class="form-page-wrapper">
        ...
        @if (session('success'))
            <div class="alert alert-success"
                style="padding: 1rem; background: #d4edda; color: #155724; border-radius: 4px; margin-bottom: 1rem;">
            ...
            <div class="card-body">
                <div class="mb-4 pb-3 border-bottom border-secondary">
                    <form action="{{ route('stock_opnames.create') }}" method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <select name="brand_id" class="form-select form-select-sm bg-dark text-white border-secondary">
                ...
                <form action="{{ route('stock_opnames.store') }}" method="POST" id="opnameForm">
                    ...
                    <div class="row mb-4 mt-2">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-semibold small mb-1 text-white">Petugas (Penanggung Jawab)</label>
                        ...
                        <table class="table table-hover table-bordered table-sm table-dark align-middle mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-center text-white" style="width: 150px;">Stok Sistem</th>
                            ...
                            <tbody>
                                @forelse($products as $product)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-secondary">{{ $product->category->name ?? '-' }}</span>
                                        </td>
                                        <td><span
