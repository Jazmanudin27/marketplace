        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="background-color: var(--bg-card);">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center py-3"
                    ...
                    <h5 class="mb-0 fw-bold text-white"><i class="fas fa-history text-primary me-2"></i>Riwayat Stock Opname
                    </h5>
                    <div>
                        ...
                        <table class="table table-hover table-bordered table-sm table-dark align-middle mb-0">
                            ...
                            <tbody>
                                @forelse($histories as $history)
                                    <tr>
                                        <td class="text-secondary small">{{ $history->created_at->format('d M Y H:i') }}
                                        </td>
                                        <td class="text-white">
                                            @php
                                        ...
                                        <td class="text-nowrap font-monospace">{{ $history->masterProduct->sku ?? '-' }}
                                        </td>
