                    ...
                    <tbody>
                        ...
                        <tr style="background:{{ $profitBg }};">
                            <td class="mono">
                                ...
                                <button class="btn btn-xs btn-outline-info ms-2 py-0 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#fb-detail-{{ $order->id }}" aria-expanded="false" aria-controls="fb-detail-{{ $order->id }}" style="font-size: 0.65rem; border-color: rgba(96, 165, 250, 0.4); color: #60a5fa;">
