@extends('layouts.app')
@section('title', 'Catat Barang Keluar Gudang')
...
@section('content')
<form action="{{ route('warehouse_mutations.store_out') }}" method="POST" id="wmo-form">
@csrf

<div class="row g-3">
    {{-- Kiri: Detail Penerima --}}
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-3 bg-white mb-3 sticky-top" style="top:80px">
            <div class="card-header border-0 py-3 px-4" style="background:linear-gradient(135deg,#ef4444,#dc2626)">
                <h6 class="fw-bold text-white mb-0">
                    <i class="fas fa-sign-out-alt me-2"></i>Detail Penerima (Tujuan)
                </h6>
            </div>
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text" style="font-size:11px">Pilih departemen tujuan barang (misal: Produksi untuk resep, GA).</div>
                </div>
                ...
                {{-- Catatan --}}
                <div class="mb-4">
                    <label class="form-label fw-semibold small text-muted">Tujuan Penggunaan / Keterangan</label>
                    <textarea name="notes" class="form-control form-control-sm" rows="3"
                        placeholder="Misal: Keperluan produksi Formula A Batch 2, pemakaian ATK operasional..."></textarea>
                </div>
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <a href="{{ route('warehouse_mutations.index_out') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-3 bg-white">
            <div class="card-header border-0 py-3 px-4 d-flex justify-content-between align-items-center"
                ...
                <span class="badge bg-white text-danger" id="badge-count" style="font-size:12px">0 item</span>
            </div>
            <div class="card-body p-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-auto">
                            <button type="button" id="btn-add-product"
                                ...
                                style="background:#ef4444; height:38px">
                    ...
                    <table class="table table-hover align-middle mb-0" id="items-table">
                        <thead style="background:#f1f5f9">
                            <tr class="small text-uppercase text-muted">
                                ...
                                <th class="text-center py-2" style="width:150px">Sisa Stok</th>
                                <th class="text-center py-2" style="width:140px">Qty Keluar</th>
    ...
    $('#btn-add-product').on('click', function () {
        ...
        tr.innerHTML = `
            ...
            <td class="text-center py-2">
                <span class="badge bg-success font-monospace" style="font-size:12px">${stock} ${unit}</span>
            </td>
            <td class="text-center py-2">
