        ...
        <div class="card border-0 shadow-sm rounded-3 bg-white mb-3 sticky-top" style="top:80px">
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    {{-- Info supplier mini --}}
                    <div id="supplier-info" class="mt-2 small text-muted {{ $purchaseOrder->supplier?->phone ? '' : 'd-none' }}">
                        <i class="fas fa-phone me-1"></i><span id="supplier-phone">{{ $purchaseOrder->supplier?->phone }}</span>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" class="form-control form-control-sm" rows="2"
                        placeholder="Instruksi pengiriman, term of payment...">{{ old('notes', $purchaseOrder->notes) }}</textarea>
                </div>
                ...
                <div class="border rounded-2 p-3 mb-4" style="background:#f0f9ff">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <span class="fw-bold text-dark" id="summary-item-count">{{ $purchaseOrder->items->count() }} item</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted small">Grand Total</span>
                        <span class="fw-bold text-primary font-monospace" id="grand-total-display" style="font-size:15px">Rp {{ number_format($purchaseOrder->total_amount, 0, ',', '.') }}</span>
                    </div>
                </div>

                <div class="d-flex flex-column gap-2">
                    <button type="submit" class="btn btn-primary fw-bold py-2" id="btn-submit">
                        <i class="fas fa-save me-2"></i>Perbarui Purchase Order
                    </button>
                    <a href="{{ route('purchase_orders.show', $purchaseOrder) }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-3 bg-white">
            <div class="card-header border-0 py-3 px-4 d-flex justify-content-between align-items-center"
                ...
                <span class="badge bg-white text-primary" id="badge-count" style="font-size:12px">{{ $purchaseOrder->items->count() }} item</span>
            </div>
            <div class="card-body p-4">
                    ...
                    <table class="table table-hover align-middle mb-0" id="items-table">
                                    ...
                                    <td class="py-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" name="items[{{ $itemIndex }}][unit_price]"
                                                ...
                                                value="{{ (int)$item->unit_price }}" min="0" step="100" required>
                                        </div>
                                    </td>
                        ...
                        <tfoot style="background:#eff6ff">
                            <tr>
                                ...
                                <td class="text-end font-monospace fw-bold text-primary py-3" id="grand-total-foot" style="font-size:15px">Rp {{ number_format($purchaseOrder->total_amount, 0, ',', '.') }}</td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
