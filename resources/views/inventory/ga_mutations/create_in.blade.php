@extends('layouts.app')
@section('title', 'Catat Barang Masuk - General Affair')
@section('page-title', 'Barang Masuk GA')
...
@section('content')
<form action="{{ route('ga_mutations.store_in') }}" method="POST" id="wmi-form">
@csrf
        ...
        <div class="card border-0 shadow-sm rounded-3 bg-white mb-3 sticky-top" style="top:80px">
            <div class="card-header border-0 py-3 px-4" style="background:linear-gradient(135deg,#8b5cf6,#6d28d9)">
                <h6 class="fw-bold text-white mb-0">
                    <i class="fas fa-sign-in-alt me-2"></i>Detail Penerimaan GA
                </h6>
            </div>
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-text" style="font-size:11px">Kosongi jika berasal dari luar (pengadaan langsung).</div>
                </div>

                {{-- Departemen Tujuan --}}
                <div class="mb-3">
                    <label class="form-label fw-semibold small text-muted">Tujuan (Gudang GA)</label>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" class="form-control form-control-sm" rows="3"
                        placeholder="Misal: Pengadaan ATK Q3, penerimaan dari pembelian...">{{ old('notes') }}</textarea>
                </div>

                <div class="d-flex flex-column gap-2">
                    <button type="submit" class="btn text-white fw-bold py-2" id="btn-submit"
                        style="background:linear-gradient(135deg,#8b5cf6,#6d28d9)">
                        <i class="fas fa-check-circle me-2"></i>Simpan Barang Masuk GA
                    </button>
                    <a href="{{ route('ga_mutations.index_in') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="col-md-8">
        <div class="card border-0 shadow-sm rounded-3 bg-white">
            <div class="card-header border-0 py-3 px-4 d-flex justify-content-between align-items-center"
                ...
                <span class="badge bg-white text-purple" id="badge-count" style="font-size:12px;color:#6d28d9">0 item</span>
            </div>
            <div class="card-body p-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-auto">
                            <button type="button" id="btn-add-product"
                                ...
                                style="background:#8b5cf6; height:38px">
...
$(document).ready(function () {
    ...
    function formatItem(opt) {
        if (!opt.id) return $('<span class="text-muted">🔍 Cari barang ATK / Inventaris...</span>');
