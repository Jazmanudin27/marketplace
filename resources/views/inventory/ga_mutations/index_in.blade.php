@extends('layouts.app')
@section('title', 'Log Barang Masuk - General Affair')
    ...
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h5 class="fw-bold text-dark mb-0">Barang Masuk GA (WMI)</h5>
                    <div class="text-muted small">Log transaksi barang masuk ke Gudang General Affair</div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge text-white" style="background:#8b5cf6">
                                    {{ $m->toDepartment ? $m->toDepartment->name : 'Gudang GA' }}
                                </span>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-5 text-muted">
                                ...
                                Belum ada log barang masuk GA yang tercatat.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
