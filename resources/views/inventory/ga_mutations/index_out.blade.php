@extends('layouts.app')
@section('title', 'Log Barang Keluar - General Affair')
    ...
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h5 class="fw-bold text-dark mb-0">Barang Keluar GA (WMO)</h5>
                    <div class="text-muted small">Log transaksi penyaluran barang dari Gudang General Affair</div>
                </div>
            </div>
                ...
                <tbody>
                    @forelse($mutations as $m)
                        <tr>
                            ...
                            <td>
                                <span class="badge text-white" style="background:#8b5cf6">Gudang GA</span>
                            </td>
                            <td>
                                @if($m->toDepartment)
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-5 text-muted">
                                ...
                                Belum ada log barang keluar GA yang tercatat.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
