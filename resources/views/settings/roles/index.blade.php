            ...
            <div class="card border shadow-sm h-100">
                <div class="card-body p-3">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-primary text-white rounded p-2 me-3 d-flex align-items-center justify-content-center fs-5" style="width: 40px; height: 40px;">
                            <i class="fas fa-lock-open"></i>
                        </div>
                        <div>
                            <h6 class="mb-0 fw-semibold text-dark small">Izin Modular</h6>
                            <small class="text-muted">Akses dibatasi per modul operasional.</small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-success text-white rounded p-2 me-3 d-flex align-items-center justify-content-center fs-5" style="width: 40px; height: 40px;">
                            <i class="fas fa-users-cog"></i>
                        </div>
                        <div>
                            <h6 class="mb-0 fw-semibold text-dark small">Multi-Tenant</h6>
                            <small class="text-muted">Perubahan hanya berdampak pada tenant Anda.</small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="bg-warning text-dark rounded p-2 me-3 d-flex align-items-center justify-content-center fs-5" style="width: 40px; height: 40px;">
                            <i class="fas fa-user-shield"></i>
                        </div>
                        <div>
                            <h6 class="mb-0 fw-semibold text-dark small">Akses Admin Absolut</h6>
        ...
        <div class="col-md-8 mb-4">
            <div class="card border shadow-sm">
                <div class="card-header bg-light d-flex justify-content-between align-items-center py-2.5 px-3 border-bottom">
                    <div>
                        <h6 class="m-0 fw-bold text-primary"><i class="fas fa-users-cog me-2"></i>Daftar Role Hak Akses</h6>
                        <p class="text-muted mb-0 small">Kelola level pengguna (role) dan permission</p>
                    </div>
                        ...
                        <table class="table table-sm table-bordered table-striped table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach ($roles as $r)
                                    <tr>
                                        <td>
                                            <strong class="text-dark text-capitalize small">{{ $r->name }}</strong>
                                        </td>
                ...
                <div class="modal-content overflow-hidden">
                    <div class="modal-header d-flex align-items-center gap-3 p-3 bg-primary bg-opacity-10 border-bottom">
                        ...
                        <div class="flex-grow-1">
                            <h5 class="modal-title fw-bold fs-6 mb-0 text-dark">Tambah Role Baru</h5>
                            ...
                            <div class="card mb-3 border overflow-hidden">
                                <div class="card-header bg-light d-flex justify-content-between align-items-center py-2 border-bottom">
                                    <span class="fw-semibold text-dark small">
                                        <i class="fas fa-folder me-1 text-primary"></i>{{ $groupName }}
                                    </span>
                                    <button type="button"
                                            ...
                                            <div class="col-md-6 my-1">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input perm-checkbox" type="checkbox"
                                                        ...
                                                        id="add_{{ $key }}">
                                                    <label class="form-check-label small text-dark" for="add_{{ $key }}">{{ $label }}</label>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
    ...
    <div class="modal fade" id="editRoleModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form id="editRoleForm" method="POST">
                ...
                @method('PUT')
                <div class="modal-content overflow-hidden">
                    <div class="modal-header d-flex align-items-center gap-3 p-3 bg-warning bg-opacity-10 border-bottom">
                        <div class="bg-warning text-dark rounded-3 d-flex align-items-center justify-content-center flex-shrink-0 p-2 fs-5" style="width: 40px; height: 40px;">
                            <i class="fas fa-edit"></i>
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="modal-title fw-bold fs-6 mb-0 text-dark" id="editModalTitle">Edit Permission Role</h5>
