...
@section('content')
    <form action="{{ route('users.permissions.update', $user->id) }}" method="POST">
        ...
        <div class="row">
                ...
                <div class="card border shadow-sm">
                    <div class="card-body p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7 border-end mb-3 mb-md-0">
                                <div class="d-flex align-items-center">
                                    <div class="bg-primary text-white rounded p-3 me-3 d-flex align-items-center justify-content-center fs-3"
                                    ...
                                    <div>
                                        ...
                                        <span
                                            class="font-monospace text-muted d-block small mb-2">{{ $user->email }}</span>
                                        @if ($user->roles->first())
                                            <span
                                                class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 text-capitalize small">
                                                Role Utama: {{ $user->roles->first()->name }}
                                            </span>
                                        @else
                                            <span
                                                class="badge bg-secondary bg-opacity-10 text-muted border border-secondary border-opacity-25 small">
                                                Belum ada role
                                            </span>
                                        @endif
                                    </div>
                            ...
                            <div class="col-md-5 ps-md-4">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="{{ route('users.index') }}"
                                        class="btn btn-secondary btn-sm px-3 py-2 flex-grow-1">
            ...
            <div class="col-12">
                <div class="card border shadow-sm">
                    <div class="card-header bg-light border-bottom py-2.5 px-3 mb-4">
                        <h6 class="m-0 fw-bold text-primary">
                            <i class="fas fa-key me-2"></i>Daftar Hak Akses Khusus
                        </h6>
                    </div>
                            ...
                            @foreach ($permissionGroups as $groupName => $perms)
                                <div class="col-md-6 mb-3">
                                    <div class="card h-100 border overflow-hidden">
                                        <div
                                            class="card-header bg-light d-flex justify-content-between align-items-center py-2 border-bottom">
