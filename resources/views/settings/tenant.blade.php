    ...
    <div class="row justify-content-start">
        ...
        <div class="col-md-8">
            <div class="dashboard-card">
                <div class="card-header-line mb-4 d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="mb-0"><i class="fas fa-building text-primary me-2"></i>Profil & Pengaturan Perusahaan</h5>
                ...
                <form action="{{ route('settings.tenant.update') }}" method="POST" id="tenantForm">
                    ...
                    {{-- ── Nama Perusahaan ──────────────────── --}}
                    <div class="mb-3">
                        <label for="name" class="form-label form-label-sm fw-semibold">
                    ...
                    {{-- ── Cutoff Gaji ──────────────────────── --}}
                    <div class="mb-4">
                        <label for="cutoff_start_day" class="form-label form-label-sm fw-semibold">
                    ...
                    <div class="card-header-line my-4">
                        <h6 class="mb-0 fw-bold">
                            <i class="fas fa-map-marker-alt text-primary me-2"></i>Koordinat & Radius Lokasi Kantor
                        </h6>
                        <p class="text-muted mb-0 mt-1 small">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label for="office_latitude" class="form-label form-label-sm fw-semibold">Latitude Kantor</label>
                        ...
                        <div class="col-md-6">
                            <label for="office_longitude" class="form-label form-label-sm fw-semibold">Longitude Kantor</label>
                        ...
                        <div class="col-md-12">
                            <label for="office_radius" class="form-label form-label-sm fw-semibold">Radius Absensi Maksimal (Meter)</label>
                            <div class="input-group input-group-sm">
